...
module.exports = {
   ...
   execute: async (message, args, client, prefix) => {
    ...
    if(SearchString.startsWith("https://open.spotify.com/playlist/37i9dQZF1EIUu7mk4MUkLV?si=BAElVzjGQLa3rQ8GODi3pA&utm_source=native-share-menu")) message.channel.send({ embeds: [new MessageEmbed().setAuthor(`Spotify`, "https://i.imgur.com/cK7XIkw.png").setColor(client.embedColor).setDescription(`Playlist is loding please wait...`)]}).then(msg => { setTimeout(() => {msg.delete()}, 3000);
       })
